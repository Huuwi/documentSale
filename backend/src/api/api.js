...
api.post("/auth/buyCart", authController.buyCart)

api.post("/auth/buyDocument", authController.buyDocument)
api.post("/auth/downloadDocument", authController.downloadDocument)
